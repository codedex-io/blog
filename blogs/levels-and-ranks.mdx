...
There are currently 25 player levels that currently exist on Codédex. Experience Points (XP) gets you levels and levels get you ranks. With each rank, there’s a name and badge icon associated with it that represents your programming proficiency.
...
The majority of the current Codédex learners find themselves in the introductory ranks of Bronze and Silver for a quite a while, which is a testament to how difficult it can be to rank higher.
