...
Thanks to strong growth, we just had our **lowest net burn** in two years (since July 2023 🥲). We also signed a lease for a bigger office as we prep for the next four months. Making some big moves.
...
- OpenAI: Replaced an LLM based check with regex. Saved ~$900/month.

These two optimizations alone saved us \$8,351 this month! Which is enough for a new hire or 2,087 Wendy's 4 for \$4. 🍔
...
- 📺 Posted YouTube videos:
  ...
  - 🧊 [a16z Speedrun Application](https://www.youtube.com/watch?v=wKOhez33D1Y) (2024)
...
- 👾 Verified [GIPHY account](https://giphy.com/codedex) and added Stickers & GIFs (187k views)!
- 🍿 Posted "Triumph of the Nerds" docuseries ep. 1 in the OPC. 

**Others**

- 🚪 Decided on moving to a bigger office. Woohoo!
- 🇺🇸 Dharma (our founding engineer)’s U.S. visa was officially approved!
...
But now, the question is no longer “Will we make it?” but “What kind of company do we want to become?” and “How can we be so impactful, so transformative, that we shift the trajectory of this planet for the better?”

To get there, we're going back to the drawing board. 

So here's the plan: step 1) craft our mission statement and our story, step 2) reintroduce Codédex to the world (targeting mid to late July), and step 3) launch the manifesto this fall as our answer to the times.

Things are in motion. More in the next update.
