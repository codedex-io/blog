...
Welcome to our first edition of the Learner Projects Showcase. Here are some of last month's most liked projects in the Codédex community! 🤗
...
An account registration page for League (a MOBA game) created using HTML forms and CSS. And it also includes response buttons and text boxes. To run the code yourself, head over to Codédex’s HTML/CSS online code editor and input the code. It's one big HTML file!
