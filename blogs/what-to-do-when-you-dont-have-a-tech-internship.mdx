...
- Write articles or make video tutorials on [Codédex](https://codedex.io/community)
...
If you are not sure where to start, Codédex has [40 real-world project tutorials](https://codedex.io/projects) for you to choose from.
...
- Codédex, naturally ([17 courses](https://www.codedex.io/courses) & [40 projects](https://www.codedex.io/projects))
...
If you are not sure where to start, check out [Codédex community](https://www.codedex.io/community) or Discord server (unlocked at 100XP)!
