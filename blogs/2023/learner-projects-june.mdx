...
Welcome to our first edition of Learner Projects Showcase. Here are some of last month's most liked projects in the Codédex community! 🤗
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://github.com/caesiumtea/wordle-cli/tree/codedexver"><Button variant="yellow">View Project</Button></a>
</div>
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://github.com/MilanGrujicic/Swahili_Flashcard"><Button variant="yellow">View Project</Button></a>
</div>
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://github.com/Kingofprund/LOL-register"><Button variant="yellow">View Project</Button></a>
</div>
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://www.instagram.com/p/CtfR0SCOR9B"><Button variant="yellow">View Project</Button></a>
</div>
---
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://anime-quiz-data.web.app"><Button variant="yellow">View Project</Button></a>
</div>
