...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://codedex.io/community/project-showcase/Fcpo3WxMJZuP99hLMfgf" target="_blank" and rel="noopener noreferrer"><Button variant="yellow">View My First Website</Button></a>
</div>
