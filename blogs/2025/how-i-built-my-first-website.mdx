...
description: "In this blog post, I’ll take you behind the scenes of how I built my very first website from scratch – the exact tools and resources, the step-by-step process, and the challenges I ran into and how I overcame them. ✨"
author: Sophie Gabe
...
I wanted every component of my website to be in pixel style: social media icons, button icons, header image and even font. So, to grasp the basics, I watched this [YouTube video](https://www.youtube.com/watch?v=lfR7Qj04-UA&t=91s) by Saultoons, which covered everything I needed to get started. After that, I created a custom pixel brush in [Procreate](https://procreate.com), made a checklist of assets, and drew them one by one. 
...
![coding html css](https://i.imgur.com/eY8pf96.png)

Alright, now it was time to start coding my website, yay!!

As a beginner in HTML & CSS, I followed these two resources: [Codédex: The Origins Trilogy](https://www.codedex.io/courses) and this [YouTube video](https://www.youtube.com/watch?v=G3e-cpL7ofc) by SuperSimpleDev. Honestly, those were _all_ I needed to understand the basics, and even some advanced features of HTML and CSS.
...
Another big priority for me was making sure the website looked good on mobile. Imagine being so excited to share your heart-poured site with your friends and siblings… only for them to open it on their phones and see a messy layout! Noo, thank you! I really tried my best to make mobile version just as cute and polished as the desktop one. After all, most people browse sites on their phones these days. So, keeping that in mind is key for any future project. 📱

## Step 5: Adding JavaScript

![coding html css](https://i.imgur.com/DhfiKQ9.png)
