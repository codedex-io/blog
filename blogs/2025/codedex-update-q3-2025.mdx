...
>
  <a
    ...
    rel="noopener noreferrer"
  >
    <Button variant="yellow">See certificate on LinkedIn</Button>
  </a>
</div>
...
Another remaining revamps is the **/account** page. We fixed some common pitfalls, like entering the whole social URL and maore. The ability to easily switch between monthly and annul plans. Email newsletter settings and more! Hope you like it.

Another remaining revamp is the **/account** page. We’ve fixed a few common issues — like users entering full social URLs instead of slugs — and added improvements such as an easier way to switch between monthly and annual plans, updated email newsletter settings, and more!
