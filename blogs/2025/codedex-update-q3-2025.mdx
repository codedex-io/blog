...
As some of you might know, we operate based on 🎯 Quarterly OKRs → ✅ Weekly Goals → 🔥 Daily Standups.

We shared our [Codédex v1.0](https://www.codedex.io/blog/codedex-v1) update in August and the [GitHub Copilot Partnership](https://www.codedex.io/blog/github-copilot-partnership) in September. But what else happened in Q3?

Here's our Q3 (July - September) recap.

## 🔎 Global Search

![Monthly Challenge GIf](https://i.imgur.com/OX6MEDi.gif)

Immediately after the v1.0 launch, we rolled out global search. Over the past few months, we've been getting an increasing number of requests on how to find friends on Codédex. So we decided to add it to global header so it's easily accesible on every page outside of the learning enviornment.

Adding search completely changes depth of the product. 

Here's what you can search currently:
