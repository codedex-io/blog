...
Since we launched cerficates in August 2023 (see the original blog post), we've issued over 6,100 course certificates through Accredible. Internally, Naomi has been pushing for a visual refresh since so many people are sharing them on LinkedIn, and the current design no longer feels on-brand. So, Jackie worked her usual magic, and here are the new certificates for Python, HTML, CSS, JavaScript, React, C++, and Java.

Your resume, personal website, and LinkedIn are always evolving, so be sure to add these certificates early in your learning journey!

## ⚙️ Account Settings Revamp

Another remaining revamps is the /account page. We fixed some common pitfalls, like entering the whole social URL and more. The ability to easily switch between monthly and annul plans. Email newsletter settings and more! Hope you like it.
