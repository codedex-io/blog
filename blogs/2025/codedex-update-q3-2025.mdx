...
Meeet Lumi, your new AI code companion! Lumi is now in all the courses besides the ones without an editor. 

AI chat history is stored for 1 week. Currently, Clubbers have unlimited questions while free users have 5 questions a day.

Here are three prompts we set up for you so it's one-click away:
