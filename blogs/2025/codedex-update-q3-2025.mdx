...
A search bar tends to add a whole new layer of depth to a product, which I absolutely love.
...
Since we released cerficates in August 2023 (original blog post), we have issued 6,100+ course certificates through Accredible. Internally, Naomi has been requesting a visual update since a ton of people are sharing them on Linkedin and the design isn't very on-brand anymore. 
