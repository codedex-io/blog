...
Another remaining revamp is the **/account** page. We’ve fixed a few common UI/UX pitfalls – like users entering full social URLs instead of slugs – and added improvements such as an easier way to switch between monthly and annual plans, updated email newsletter settings, and more!
