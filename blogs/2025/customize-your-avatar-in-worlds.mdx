...
$$
7 \times 3 \times 10 \times 4 \times 5 \times 8 = 33{,}600 combinations
$$

Creating a separate sprite file for each? That’s over 33600 asset files for \*one\* character, across walking and standing animations in 4 directions. NO THANKS! 
...
Worlds is where our community comes together – for events, hackathons (raffles and winner announcements), and just hanging out. But when everyone looks the same, it's stale.
