...
So, I decided to find out which SOTA model is the "smartest" by creating my own [Clues By Sam LLM benchmarking tool](https://github.com/Syps/cbs-bench). After comparing performance across 25 puzzles of varying difficulties, the winner* is... 🥁... **GPT-5 Pro!** 🎉 **As of Nov 13, 2025*
