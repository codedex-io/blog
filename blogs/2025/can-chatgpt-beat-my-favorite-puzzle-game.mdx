...
Lately, I've been obsessed with a daily puzzle game called [Clues By Sam](https://cluesbysam.com/). It's a game of logical deduction where you mark people in a 4x5 grid as either *Criminal* or *Innocent*. Each person you reveal gives you a new piece of information, which you then use to deduce the next person's identity, and so on.

You start with one person already revealed:

![clues by sam game grid](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/game-grid-bottom.png)
...
![game results](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/results.png)
...
![conversation about llms](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/chat-screenshot.png)

So, I decided to find out which SOTA model is the "smartest" by creating my own [Clues By Sam LLM benchmarking tool](https://github.com/Syps/cbs-bench). After comparing performance across 25 puzzles of varying difficulties, the winner* is... 🥁 **GPT-5 Pro 🎉**

**As of Nov 13, 2025*

Below are the results of testing 5 different frontier models against 25 puzzles of varying difficulty.
...
![easy difficulty performance](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/horiz_chart_easy.png)

### Medium 💪

![medium difficulty performance](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/horiz_chart_med.png)

### Hard 😮‍💨

![hard difficulty performance](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/horiz_chart_hard.png)

### Brutal 😱

![brutal difficulty performance](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/horiz_chart_brutal.png)

### Evil 😈

![evil difficulty performance](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/horiz_chart_evil.png)
...
![race mode interface](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/race-mode.png)
...
![clues by sam game grid](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/game-unserialized-example.png)
...
GPT-5 far surpassed my expectations of how well a SOTA LLM could perform. And by that I mean it beats me... a lot. GPT-5's knowledge cutoff is [September 2024](https://platform.openai.com/docs/models/compare). Based on the creator's [original HN post](https://news.ycombinator.com/item?id=43821457), [Clues By Sam](https://cluesbysam.com/) went live in April 2025. We can therefore assume that no information about the game exists in GPT-5's training data. So how does it perform so well? Is it actually capable of "reasoning"?
...
![frontier model perfomance imessage commiseration](../../blog-images/can-chatgpt-beat-my-favorite-puzzle-game/imessage-commiseration.png)
