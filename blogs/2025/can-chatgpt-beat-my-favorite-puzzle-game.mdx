...
So, I decided to find out which [SOTA model](https://www.google.com/search?q=SOTA+model) is the "smartest" by creating my own [Clues By Sam LLM benchmarking tool](https://github.com/Syps/cbs-bench) using Python and langchain. 

After comparing performance across 25 puzzles of varying difficulties...
