...
Here are some places where I would recommend starting:
...
**[Phaser](https://codedex.io/phaser)** is a popular JavaScript framework designed for making web games. It handles physics, animations, input, and audio, letting you focus on your game logic. Games run directly in the browser and are easy to share via a link. You can even embed them on a website, making it seamless to showcase your creations.
...
**[Lua](https://codedex.io/lua)** is a scripting language, popular for making mods for games like Baldur's Gate 3, World of Warcraft. It’s a language syntactically similar to Python, and can be used with the LÖVE2D framework, which was used to build the 2025 game of the year, Balatro. 
...
- [Twine](https://twinery.org/): A choose your own adventure text based game editor that uses HTML, CSS, and JavaScript!
...
You can also publish on itch.io, on Android or iPhone app stores, or even the Codédex Community! 👯
...
**[Project Showcase](https://www.codedex.io/community/project-showcase)**: There's now a **(Game)** tag for all the community projects!

<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a href="https://www.codedex.io/community/project-showcase" style={{ all: "unset" }} target="_blank" and rel="noopener noreferrer"><Button variant="yellow">View games in Project Showcase</Button></a>
</div>
