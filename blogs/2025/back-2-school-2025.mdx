...
Ellie, curriculum developer, hosts a CS panel with two recent grads (SWEs at Atlassian & Microsoft) and one CS student (ex-TD Bank) and they spill _all_ the tea: from languages to know when working in big tech to internship interview questions. 🤫
