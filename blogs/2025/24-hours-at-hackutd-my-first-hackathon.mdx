...
It’s 4 AM. Most people are asleep, but here I am, watching the [League Championship Finals](https://en.wikipedia.org/wiki/2025_League_of_Legends_World_Championship) in a room with my teammates while trying to code our hackathon project that might not even work. Welcome to my first hackathon.
