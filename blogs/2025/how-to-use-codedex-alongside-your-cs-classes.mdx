...
This should not come as a surprise, because the classes and exams are so darn hard. We believe this is mainly because:
...
That being said, we want to help you get through your CS classes with a bit more ease.
## Courses

### Intro Programming / CS 121 / CS 101
...
<div style={{ display: "flex", justifyContent: "center", marginBottom: "1.2rem", transform: "scale(.9)" }}>
  <a style={{ all: "unset" }} href="https://www.codedex.io/courses" target="_blank" and rel="noopener noreferrer"><Button variant="yellow">Explore Coursesk</Button></a>
</div>
