...
This paired with the gap between traditional education and the real-world skills PLUS the poor job market.

But it doesn't have to be that way! Here's how you should use Codédex if you are a CS student.
