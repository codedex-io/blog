...
Hey everyone! It's Ellie, and chances are, you're a Computer Science student right now a few weeks into learning how to code in your CS classes, or you're in the last couple years of school hoping refresh yourself on all the fundamentals and make it out alive! 

Look no further because Codédex is here to help you supplement brutal CS classes with fun, interactive features to help you pass all your classes with an A!
...
- Inadequate support
- Poor preparation
- Professors that don't know how to teach

But that doesn't need to be the case! 

We want to show you exactly how to help you get through your CS classes with a bit more ease. So let's get into it.
