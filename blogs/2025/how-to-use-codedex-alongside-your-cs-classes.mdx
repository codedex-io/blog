...
**Hey everyone!** It's Ellie. 👋 Chances are, you're a Computer Science student right now a few weeks into learning how to code in your CS classes, or you're in the last couple years of school trying to refresh the fundamentals and just make it out alive~

Look no further, because Codédex is the perfect complement to your CS journey – making tough classes fun and helping you ace all your exams and projects.

## The Current CS Landscape

Before we get started, let's understand the current landscape.

In 2025, the **dropout rate for CS students was reported hit 10.7%**, the highest among all college majors. 😱 ([Mission: Graduate](https://missiongraduatenm.org/college-dropout-statistics))

This should not come as a surprise, we all know someone that switched majors... because CS can feel **impossibly hard** (and boring lol). Here's why:
...
This + the gap between traditional education and the real-world skills + the down cycle of job market = you have be on your A game!

Don't sweat. We gotchu. Here's how you should use Codédex if you are a CS student.
