...
- [AP CS A vs Principles]()
- [Topics covered in AP CS A & Dates]()
- [Topics covered in AP CS Principles & Dates]()
- [Ellie's *foolproof* self-study guide]()
- [Resources]()
...
- End of course exam: 70 multiple choice questions, 2 hours, 70% of your score
- Create Performance Task: 30% of your score
...
4. In May, you're only doing light reviews. Aim to be familiar with everything by this time, and only do some light practice for your FRQs. 
...
- [Java Challenge Packs](https://www.codedex.io/java/challenge-packs): Practice problems for you to challenge what you know
