...
React single-page web app featuring an advent calendar that allows users to collect loots and win gift cards! The judges and the team all thought this was sooo well done. Congrats, Iris! :)
...
There were 37 other amazing projects, so here are some more shoutouts:
...
- **[Santa Locator](https://www.codedex.io/community/monthly-challenge/submission/mH5uUZq9XKN0dDkGZy5K)** - Team Banana (@_bananenmus_, @susucaster, @siccghxst)
- **[New Years Eve Countdown](https://www.codedex.io/community/monthly-challenge/submission/WSMEyHdrzyIHO1OXpAqg)** - NoCap Code Connoisseurs (@jwonpee, @jojol_)
